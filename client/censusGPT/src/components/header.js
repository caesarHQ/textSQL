...
const navigation = [
  { name: 'Star on Github', href: 'https://github.com/caesarhq/textSQL' },
  { name: 'Discord', href: 'https://discord.gg/JZtxhZQQus' },
...
export default function Header(props) {
  ...
  return (
    <header className="bg-white">
      ...
      {/* TODO @rahul : This is for Mobile. Get it to the work */}
